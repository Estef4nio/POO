class ModalidadesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @modalidade.save
        format.html { redirect_to modalidade_url(@modalidade), notice: "Modalidade was successfully created." }
  ...
  def update
    respond_to do |format|
      if @modalidade.update(modalidade_params)
        format.html { redirect_to modalidade_url(@modalidade), notice: "Modalidade was successfully updated." }
  ...
  private
    ...
    def modalidade_params
      params.require(:modalidade).permit(:nome, :cargaHorariaMaxima)
    end
end
